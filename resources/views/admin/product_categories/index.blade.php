...
<div class="col-span-2 p-2 ">
    ...
    <div class="bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
        <div class="items-center justify-between block pb-4 bg-white sm:flex md:divide-x dark:bg-gray-800 dark:border-gray-700">
